...
headyoung <- head(sort(allgenesyoung, decreasing=TRUE), 10)
headyoung
...
headold <- head(sort(allgenesold, decreasing=TRUE), 10)
headold
...
summary(mylogit)
```
Younger patients in general were more likely to do worse in this study. We did a statistically significant difference in the distribution of genes in the younger patients relative to the older patients. In a logistic regression, while overall gene counts did not make a difference, age at diagnosis could be accounted for separately from stage. 
